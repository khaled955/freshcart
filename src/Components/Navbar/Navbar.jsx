      ...
      <nav className="bg-slate-100 py-3 shadow-md fixed w-full top-0 left-0 z-50">
        <div className="container flex items-center justify-between w-full">
          ...
          <div
            ...
            } md:flex justify-between items-center  gap-3 top-[100%] bg-slate-100  flex-col md:flex-row w-full`}
          >
            {token && (
            ...
            {token && (
              <Link to="/cart" className="cart-car mt-3 md:mt-0 mr-6 relative">
            ...
            <ul className="flex items-center gap-4 mr-4  justify-center">
              <li>
            ...
            <div className="btn-box flex gap-1 flex-wrap my-4 md:my-0">
              {!token && (
                <>
                  <Link to="/login">
          ...
          <div className="nav-bar mr-3 md:hidden">
            <i
              onClick={handleShowLinks}
              className="fa-solid fa-bars font-bold text-lg"
            ></i>
          </div>
        </div>
      </nav>
